			...
			<!-- 졸작 소개 텍스트 창 -->
			    ...
			    <div class="col-sm-12">
  				<label class="form-label"></label>
			        <input type="text" class="form-control" name="#" placeholder="팀명" value="" required>
			    </div>
			
			    <div class="col-sm-4">
  				<label class="form-label"></label>
			        <input type="text" class="form-control" name="#" placeholder="팀원" value="" required>
			    </div>
			    ...
			    <div class="col-12">
			        ...
			        <div class="input-group has-validation">
			            <textarea class="form-control" name="gameTrailer" placeholder="게임 소개" value=""
			                required></textarea>
			        </div>
			    </div>
			    <hr class="my-4">
			 ...
			 <h4>
			  ...
			  <!-- 이미지 유튜브 업로드 -->
			      ...
			      <div class="input-group pt-2 pb-3">
			          <input type="text" name="gameurl" class="form-control " value="" required
			                 placeholder="게임 소개 영상">
			      </div>
			      <!--  유튜브 업로드 -->
