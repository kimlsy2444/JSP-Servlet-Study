...
<body >
  ...
  <main class="container mt-5">
    ...
    <!-- 이미지 유튜브 업로드 -->
    <form name = "newGameInfo"action="./processAddGameInfo.jsp"  class="needs-validation" novalidate  method="post"  enctype="multipart/form-data">
    <div class="row g-5">
      ...
      <!-- 타이틀 이미지 썸네일 -->
          <div class="input-group pt-2">
            <input class="form-control" type="file" name="gameTitleImage" value="" required   onchange="setThumbnail(event);" >
        ...
        <form class="card p-2">
          ...
          <div class="input-group pt-2">
          <input class="form-control" type="file" name="gameImage" value="" required  multiple onchange="setDetailImage(event);" >
          </div>
        </form>
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <input type="text" class="form-control"name ="gameTrailer"  placeholder="짧은 소개" value="" required>
