...
<% Connection conn = DBConn.getConnection(); %>
	...
	%>
         	<header class="login__header">
                <h3 class="login__title">Code In</h3>
            </header>
			<form class="form login" action="Registration.jsp" method="post">
            <div class="login__body">
                <div class="form__field">
             	    <input type="password" placeholder="Code In" name="gameCode" required>
                </div>
            </div>
